...
---------------------------------------------------------------
-- 1b. Установка перехвата вывода UTF-8 → CP1251.
-- Должно быть как можно раньше, до любого print с кириллицей.
-- Работает только если установлен ресурспак znatokos-cyrillic;
-- без него просто поменяет один набор квадратиков на другой.
---------------------------------------------------------------
