...
-- Точка входа приложения ZnatokOS v0.3.0 (скрипт верхнего уровня).

-- Определяем текущего пользователя: либо из контекста приложения,
-- либо через VFS как запасной вариант.
